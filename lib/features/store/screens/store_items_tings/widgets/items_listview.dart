                  ...
                  itemBuilder: (context, index) {
                    ...
                    switch (space) {
                      case "refunds":
                        ...
                        unitSellingPrice = salesController
                                .foundRefunds.isNotEmpty
                            ? salesController
                                .foundRefunds[index].unitSellingPrice
                          ...
                          child: CExpansionTile(
                            ...
                            btn1NavAction: () {
                              ...
                              if (space == 'sales') {
                                Get.toNamed(
                                  '/sales/txn_details',
                                  arguments: salesController
                                          .foundSales.isNotEmpty
                                      ? salesController
                                          .foundSales[index].soldItemId
