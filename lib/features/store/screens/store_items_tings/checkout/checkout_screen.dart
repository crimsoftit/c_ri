    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Padding(
            padding: const EdgeInsets.only(top: 8.0, bottom: 12.0, left: 0),
            child: Obx(
              () {
                ...
                return searchBarController.showAnimatedTypeAheadField.value
                    ...
                    AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: searchBarController
                                  .showAnimatedTypeAheadField.value
                            ...
                            children: [
                              ...
                              SizedBox(
                                height: cartController.cartItems.length <= 2
                                    ...
                                    : CHelperFunctions.screenHeight() * 0.40,
                                child: CRoundedContainer(
                                  padding: EdgeInsets.all(
                                    CSizes.defaultSpace / 6,
                                  ),
